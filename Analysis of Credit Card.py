...
df = pd.read_csv(r"C:\Users\laiju\PycharmProjects\SouthGermanCredit\SouthGermanCredit.asc",sep=' ')
df
...
df.to_csv(r'C:\Users\laiju\PycharmProjects\SouthGermanCredit\Preprocess.csv')
