...
class dataBaseOperation:
    ...
    def __init__(self):
        ...
        self.client_id = 'kXgbEEeffcfDFMepzLgZIZqC'

        self.client_secret = 'lqiKrdqpA4MgjHSBMh,OdE_cNhsy_6Zv.3hSFgA5C2AIkPtQxMQcep1NOoj6xxD5c7JH6FYvoYapYKgzBL1ncbsEIX8EwFo8Un4W5BGtHqZi.j81q4HnCNLRp3oLtzS7'

        self.cloud_config = {
            'secure_connect_bundle': r"C:\Users\laiju\PycharmProjects\SouthGermanCredit\secure-connect-south-german-bank-data.zip"}
